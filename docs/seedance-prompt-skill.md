...
- **图片风格必须与视频主题契合**：根据主题自动匹配合适的图片风格，例如：
  ...
  - 仿实拍/UGC/生活感短视频 → 手机或轻量相机手持实拍质感；自然日光、窗边柔光或室内顶光，避免棚拍级布光；轻微手持晃动、跟拍呼吸感、偶发对焦偏移；真实皮肤纹理与生活化场景（家居、街头、门店、工位），保留环境杂物与使用痕迹；色彩偏自然中性、低饱和、少滤镜；剪辑节奏贴近抖音/小红书种草、开箱、测评、日常 Vlog，一镜到底或快切但不花哨
